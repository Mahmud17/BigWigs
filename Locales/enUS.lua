...
L.colorBarsByType = "Color bars by mechanic type"
L.colorBarsByTypeDesc = "Colors a bar using the same color as its warning message (if the boss module registers one) instead of the normal bar color. Falls back to the normal bar color for anything that doesn't have one."
L.testBarColorBtn = "Test Bar Color"
L.testBarColorBtn_desc = "Creates a short test bar using a real ability that has a registered color, to preview mechanic-type bar coloring. The Bars/Timeline test buttons can't be used for this since they use a Blizzard preview system with no real ability behind it."
L.testBarColorBtn_none = "No currently loaded ability has a registered color to test with."
...
L.borderDispelColor = "Color border by dispel type"
