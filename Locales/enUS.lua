...
L.highlightTargetBars = "Clearer Debuff View"
L.highlightTargetBarsDesc = "Highlights the icon of a targeted bar (for example a tank debuff): green when it's on you, purple when it's on someone else specifically (for example the co-tank), so they're easy to tell apart."
L.font = "Font"
L.restart = "Restart"
