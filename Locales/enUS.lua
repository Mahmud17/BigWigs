...
L.highlightMyTargetBar = "Highlight My Target Bars"
L.highlightMyTargetBarDesc = "Adds a colored highlight to the icon of a targeted bar (for example a tank debuff) when it's on you, so it's easy to tell apart from the same bar on someone else."
L.font = "Font"
L.restart = "Restart"
